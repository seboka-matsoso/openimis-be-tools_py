...
class ToolsConfig(AppConfig):
    ...
    def _configure_permissions(self, cfg):
        ...
        ToolsConfig.registers_health_facilities_perms = cfg["registers_health_facilities_perms"]
        ...
        ToolsConfig.extracts_officer_feedbacks_perms = cfg["extracts_officer_feedbacks_perms"]
        ToolsConfig.extracts_officer_renewals_perms = cfg["extracts_officer_renewals_perms"]
